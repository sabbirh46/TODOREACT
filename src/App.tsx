...
export const App: FC = () => {
  ...
  return (
    <LoadContext.Provider value={loadingTodos}>
      ...
      <div className="font-sans font-light text-xl text-gray-700 w-[600px] mx-auto ">
        <h1 className=" pt-[60px] text-[100px] font-sans text-center text-red-700 pb-[60px] text-opacity-[.25]">
          todos
        </h1>
